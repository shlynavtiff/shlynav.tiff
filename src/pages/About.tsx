    ...
    <div className="flex-grow flex-col flex items-center justify-center">
      ...
      <div className="max-w-[1080px] w-full leading-extra-tight font-bold text-[20px] sm:text-[30px] md:text-[35px] px-4 ">
        ...
        on side projects, learning new <a href="https://www.techtarget.com/whatis/definition/framework" target="_blank" onMouseEnter={() => setCursorVariant('text')}
           onMouseLeave={() => setCursorVariant('default')}>frameworks</a>, and building personalized mechanical keyboards. He is
        currently studying <a href="https://en.wikipedia.org/wiki/Computer_science" target="_blank" onMouseEnter={() => setCursorVariant('text')}
           onMouseLeave={() => setCursorVariant('default')}>Computer Science</a> at <a href="https://qcu.edu.ph/" target="_blank" onMouseEnter={() => setCursorVariant('text')}
           onMouseLeave={() => setCursorVariant('default')}>Quezon City University</a>, an experience he holds fondly and
        ...
        <a href="mailto:naval.ashleyjames.redacto@gmail.com" target="_blank" className="font-bold  hover:underline ml-1 "
