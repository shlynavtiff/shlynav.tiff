      ...
      <div className="max-w-[1080px] w-full leading-[.85] font-bold text-[20px] sm:text-[30px] md:text-[35px] px-4 ">
        ...
        currently studying <a href="https://en.wikipedia.org/wiki/Computer_science" target="_blank" onMouseEnter={() => setCursorVariant('text')}
          onMouseLeave={() => setCursorVariant('default')} className='underline'>Computer Science</a> at <a href="https://qcu.edu.ph/" target="_blank" onMouseEnter={() => setCursorVariant('text')}
            onMouseLeave={() => setCursorVariant('default')} className='underline'>Quezon City University</a>, an experience he will hold fondly and
        will cherish for the rest of his life. His goal is to continuously grow as a developer and eventually build tools that make technology more accessible to people. If you have an interesting idea,
